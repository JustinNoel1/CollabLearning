\documentclass[english,a4paper]{amsart}
...
\begin{figure}
	\begin{center} \includegraphics[scale=0.6]{images/MNIST_Sample_Images.png}\end{center}
	\caption{MNIST}\label{MNISTFig}
\end{figure}
...
\begin{figure}
	\begin{center} \includegraphics[scale=0.6]{images/notMNIST_Sample_Images.png}\end{center}
	\caption{notMNIST}\label{notMNISTFig}
\end{figure}
...
\begin{figure}
	\begin{center} \includegraphics[scale=0.6]{images/CIFAR10_Sample_Images.png}\end{center}
	\caption{CIFAR10}\label{CIFAR10Fig}
\end{figure}
